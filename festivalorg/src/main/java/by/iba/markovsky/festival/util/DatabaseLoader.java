...
/*        Identity identity = new Identity("Павел", "Марковский", String.valueOf(21));
        WebIdentity webIdentity = new WebIdentity("markovskypavel",
                "Qwerty123", EncryptedPasswordUtil.encrytePassword("Qwerty123"),
        ...
        Place place = new Place("ул. Воронянского 27", String.valueOf(10));
